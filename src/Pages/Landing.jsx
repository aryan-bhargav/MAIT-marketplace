...
const Landing = () => {
    return (
        <div className="min-h-screen bg-gray-900 text-gray-100">
            ...
            {/* Hero Section */}
            <section className="text-center px-4 md:px-10 py-10 ">
                <div className="flex flex-col-reverse md:flex-row items-center justify-between max-w-7xl mx-auto">
                    ...
                    <div className="w-full md:w-1/2 text-center md:text-left mt-8 md:mt-0">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
                            <Link className="bg-blue-600/50  text-white px-6 py-3 rounded  border-[0.5px] border-white hover:bg-gray-2000" to="/browse">Browse Items
                            </Link>
 
                            <Link className="bg-gray-800 text-white px-6 py-3 rounded border border-gray-600 hover:bg-gray-700" to="/sell">Post an Item
                            </Link>
                        </div>
                    </div>
            ...
            {/* CTA Section */}
            <section className=" text-white py-12 text-center px-4">
